...
Hello! I'm Madelline, and this repository brings together the data analysis projects I have developed to demonstrate my skills in data cleaning, exploratory analysis, SQL, visualization, and data storytelling.

## Tools
Python (pandas, matplotlib, seaborn) · SQL (SQLite) · Power BI · Tableau · Excel
